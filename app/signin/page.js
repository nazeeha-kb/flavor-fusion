...
export default function SigninPage() {
  ...
  const { enterGuestMode, isAuthenticated, isGuest } = useGuestSession();
  ...
  return (
    <div className="bg-gray-50 min-h-[84vh] overflow-hidden">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md w-[80vw] shadow-lg">
              <div className="bg-white py-8 px-4 sm:rounded-lg sm:px-10">
                ...
                >
                  ...
                  {error && (
                    <div className="rounded-md border border-red-200 bg-red-50 px-3 py-3 text-sm text-red-600">
                      <p>{error}</p>
                      <div className="mt-3 flex flex-wrap gap-2">
                        <button
                          type="button"
                          onClick={() => setError("")}
                          className="rounded-md border border-red-300 px-3 py-1 text-sm font-medium text-red-700 hover:bg-red-100"
                        >
                          Try Again
                        </button>
                        <button
